...
export default function NuevaPautaPage() {
  ...
  const [submitting, setSubmitting] = useState(false); // Renamed from loading to match pattern
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">
                Nueva Pauta de Mantención
              </h1>
              <p className="text-slate-500 dark:text-slate-400 text-sm">
                Define un nuevo protocolo de mantención con su checklist
              </p>
            </div>
          </div>
